...
1. How to animate things in more succinct ways (less code)
2. How do control the fade-in of the "Take Carousel for a Spin" button
...
Would have liked to complete more of the optional tasks - will spend more time on the HW next week!
